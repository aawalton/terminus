...
async function migrateOutlineOfKnowledge() {
  try {
    ...
    const outline = {
      '1. Matter and Energy': {
        ...
        '1.2 Energy, Radiation, and States of Matter': [
          ...
          '1.2.6 Mechanics of Particles, Rigid and Deformable Bodies',
      ...
      '4. Human Life': {
        ...
        '4.3 Human Behavior and Experience': [
          ...
          '4.3.3 Influence of the current environment on a person\'s behavior and conscious experience',
          '4.3.4 Current Internal states affecting a person\'s behavior and conscious experience',
      ...
      '5. Society': {
        ...
        '5.4 Politics and Government': [
          ...
          '5.4.2 Political Institutions',
          '5.4.3 Functioning of Government',
      ...
      '8. Religion': {
        ...
        '8.2 Particular Religions': [
          ...
          '8.2.4 Buddhism',
          '8.2.5 Indigenous Religions of East Asia',
          '8.2.6 Judaism',
          '8.2.7 Christianity',
          '8.2.8 Islam',
      ...
      '9. History': {
        ...
        '9.6 The Modern World to 1920': [
          ...
          '9.6.11 Southwest Asia, North Africa 1800–1920, Sub-Saharan Africa 1885–1920'
        ],
    ...
    for (const [topLevel, secondLevel] of Object.entries(outline)) {
      const topLevelId = await insertSkill(topLevel)
    ...
    // Update Mathematics parent to point to "10.2 Mathematics" section
    await updateMathematicsParent(mathId, sectionIds['10.2 Mathematics'])
